...
def attack(char_name, char_class):
    if char_class == 'warrior':
        return (f'''{char_name} нанёс урон противнику равный {5 + randint(3,
         5)}''')
    if char_class == 'mage':
        return (f'''{char_name} нанёс урон противнику равный {5 + randint(5,
        10)}''')
...
def special(char_name, char_class):
    if char_class == 'warrior':
        return (f'''{char_name} применил специальное умение «Выносливость {80 +
        25}»''')
    if char_class == 'mage':
